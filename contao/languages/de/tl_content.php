...
$GLOBALS['TL_LANG']['tl_content']['dw_page'] = ['Zu verlinkende Seite','Wählen Sie die Seite aus zu der verlinkt werden soll.'];
$GLOBALS['TL_LANG']['tl_content']['dw_linkText'] = ['Link-Text','Der Link-Text wird anstelle der Link-Adresse angezeigt.'];
